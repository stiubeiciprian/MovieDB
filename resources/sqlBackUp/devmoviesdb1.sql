...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Mai 2018 la 14:47
...
(25, 'Terminal', 'https://www.youtube.com/embed/18RqtFuaNe8', 150, '2018-06-11', 'In the dark heart of a sprawling, anonymous city, TERMINAL follows the twisting tales of two assassins carrying out a sinister mission, a teacher battling a fatal illness, an enigmatic janitor and a curious waitress leading a dangerous double life. Murderous consequences unravel in the dead of night as their lives all intertwine at the hands of a mysterious criminal mastermind hell-bent on revenge.'),
(26, 'Venom', 'https://www.youtube.com/embed/u9Mv98Gr5pY', 135, '2018-06-05', 'When Eddie Brock acquires the powers of a symbiote, he will have to release his alter-ego \"Venom\" to save his life.\r\n');
...
(12, 1, 7, 'Review', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi convallis libero ac dictum rutrum. Pellentesque fringilla sed magna eget tempor. Nulla luctus tellus et gravida congue. In bibendum ante dolor, sit amet dictum justo bibendum vitae.'),
(13, 1, 19, 'Lorem ipsum', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ornare risus eget aliquam fringilla. Integer odio nibh, malesuada vel diam in, blandit accumsan risus. Suspendisse vitae arcu lorem. In pretium ultrices mauris. Sed aliquet odio vitae volutpat semper. Duis nisl ligula, condimentum at massa sit amet, posuere ullamcorper enim. Nulla neque libero, pulvinar non dapibus eu, egestas faucibus mauris. Fusce consectetur enim justo, ac cursus lacus accumsan accumsan.'),
(14, 1, 19, 'Review', 'Duis metus mauris, porttitor eget mauris ut, interdum fringilla turpis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam fringilla lectus ut ex ultrices venenatis. Praesent enim odio, condimentum in porttitor vitae, consectetur vel erat. Aenean eget ante condimentum, luctus ligula vitae, posuere nibh. Donec quis ornare massa. Maecenas tincidunt risus sed augue bibendum maximus. Sed accumsan sagittis dui, quis dignissim quam lobortis ut.'),
(15, 1, 8, 'Review', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ornare risus eget aliquam fringilla. Integer odio nibh, malesuada vel diam in, blandit accumsan risus. Suspendisse vitae arcu lorem. In pretium ultrices mauris. Sed aliquet odio vitae volutpat semper. Duis nisl ligula, condimentum at massa sit amet, posuere ullamcorper enim. Nulla neque libero, pulvinar non dapibus eu, egestas faucibus mauris. Fusce consectetur enim justo, ac cursus lacus accumsan accumsan.');
...
(2, 'Uploader', 'uploader', 'uploader@devmail.com', 'uploader'),
...
--
ALTER TABLE `movie`
  MODIFY `m_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `review`
--
ALTER TABLE `review`
  MODIFY `r_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
